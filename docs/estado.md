...
- **Últimas tareas cerradas:** 2.5·T0 y 3·T0b, ya con commit y subidas (`feat/2.5-t0`, `feat/3-t0b`). Se cerraron con `npm test` en rojo sin diagnosticarlo: ver riesgos. CI arreglado en `fix/ci-verde`: los cuatro trabajos en verde por primera vez (run 35970750852)
- **Siguiente:** 3·T0c (paridad del stub y prueba conductual del borrado), 2.5·T2 y 3·T1
